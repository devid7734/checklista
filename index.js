...
const headers = {
  "X-Parse-Application-Id": "XjnKm5T5hhhUOQu94CTdEyqUhNZUDMMgzMxGoFYf",
  "X-Parse-REST-API-Key": "kiiI5R0pB8nXejfwfVXUqXRafoaj68ckxfupJas0",
};
...
const renderizaLista = (lista, tarefas) => {
  ...
  tarefas.forEach((tarefa) => {
    ...
    checklist.checked = tarefa.done;
    checklist.onchange = () => updateTask(tarefa,checklist.checked);

    const listItem = document.createElement("li");
    listItem.appendChild(itemText);
    listItem.appendChild(buttonDelete);
    listItem.appendChild(buttonUpdate);
    listItem.appendChild(checklist);
